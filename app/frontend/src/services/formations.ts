...
import type { FormationPlayer, MemberAssignmentOverview, PlayerRole, Session, SessionInput, TeamFormation, TeamFormationInput } from "../types/formation";
...
export const getMemberAssignmentOverview = () => api.get<MemberAssignmentOverview[]>("/formations/assignment-overview");
